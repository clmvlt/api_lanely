...
@Schema(name = "CreateVehicleRequest", description = "Payload to create a vehicle of the transport company's fleet")
public record CreateVehicleRequest(

        @Schema(description = "Registration (license) plate, unique within the company", example = "AB-123-CD", requiredMode = Schema.RequiredMode.REQUIRED)
        @NotBlank
        @Size(max = 16)
        ...
        @Schema(description = "Vehicle category", example = "TRUCK", requiredMode = Schema.RequiredMode.REQUIRED)
        @NotNull
        ...
        @Schema(description = "Insurance details. All fields optional.", nullable = true)
        @Valid
